#!/usr/bin/bash
cd /home/cuffe002adm/MAMBA2 ###fill in your mamba directory here
...
export outputPath=/home/cuffe002adm/MAMBA2/output ##the path for our output files
...
export inputPath=/home/cuffe002adm/MAMBA2/data ##path to your data
